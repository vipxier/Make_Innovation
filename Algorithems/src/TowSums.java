...
public class TowSums
{
   ...
   */
    ...
    /*
     * Get the all the possible value pairs in the array to sum up to the value in the array.
     * 
     * Example:
     * array: { 1, 3, 4, 5, 1, 1, 1, 16, 7, 8, 9 }
     * Result : 16: 9 7
     *          9:  5 4
     *          9:  8 1
     *          8:  5 3
    ...
    public List<Set<Integer>> getAllPossibleNumbers(int[] array, int target)
    {
